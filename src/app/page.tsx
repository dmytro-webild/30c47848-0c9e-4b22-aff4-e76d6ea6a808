...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      testimonials={[
        {
          name: "সায়মা বেগম",
          handle: "@সায়মা_বেগম",
          testimonial: "রন্ধন শালারা সেরা খাবার পরিবেশন করে! তাদের চিকেন বিরিয়ানি অতুলনীয়।",
          rating: 5,
        ...
        },
        {
          name: "আরিফ হোসেন",
          handle: "@আরিফ_হোসেন",
          testimonial: "পরিবেশ খুবই চমৎকার এবং সার্ভিসও দুর্দান্ত। আমি পিজ্জা আর ক্রাম্ব প্রন ফ্রাই খুব পছন্দ করেছি।",
          rating: 5,
        ...
        },
        {
          name: "ফারিহা ইসলাম",
          handle: "@ফারিহা_ইসলাম",
          testimonial: "তাদের স্পেশাল স্যুপটা এত মজাদার যে বারবার খেতে ইচ্ছা করে। এখানকার খাবারের মান অসামান্য!",
          rating: 4,
        ...
        },
        {
          name: "মাহমুদ হাসান",
          handle: "@মাহমুদ_হাসান",
          testimonial: "পরিবারের সাথে ভালো সময় কাটানোর জন্য পারফেক্ট জায়গা। খাবার সব ফ্রেশ আর সুস্বাদু।",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-girl-with-hand-her-chin_1169-110.jpg",
        },
        {
          name: "তাসনিয়া জান্নাত",
          handle: "@তাসনিয়া_জান্নাত",
          testimonial: "রন্ধন শালারা সত্যিই খাবারের স্বাদ এবং গুণগত মান বজায় রেখেছে। তাদের সেবাও প্রশংসনীয়।",
          rating: 4,
        ...
        },
        {
          name: "নুরুল আমিন",
          handle: "@নুরুল_আমিন",
          testimonial: "আমি তাদের মেন্যুর ক্রাম্ব প্রন ফ্রাই এর ভক্ত। খুবই মুচমুচে আর সুস্বাদু ছিল!",
          rating: 5,
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/woman-with-speech-bubble-showing-smiling-face-cold-sweat-emoji_23-2147842250.jpg",
          alt: "Customer Fariha",
        },
        {
          src: "http://img.b2bpic.net/free-photo/close-up-portrait-complicated-troubled-woman-glasses-frowning-looking-displeased-standing_1258-127276.jpg",
          alt: "Customer Mahmud",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "আমাদের সম্পর্কে: রন্ধন শালারা কে?",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/woman-working-as-professional-chef_23-2151864180.jpg",
          alt: "Chef cooking in a modern kitchen",
        },
      ]}
      buttons={[
        {
          text: "আমাদের গল্প জানুন",
          href: "#contact-info",
        },
      ]}
    />
      ...
      products={[
        {
          ...
          imageAlt: "Chicken BBQ Pizza",
        },
        {
          id: "product-2",
          name: "Crumb Prawns Fry",
          price: "৳২৫০ - ৳৩৫০",
          imageSrc: "http://img.b2bpic.net/free-photo/granita-dessert-with-orange-still-life-flat-lay_23-2149412331.jpg",
          imageAlt: "Crumb Prawns Fry",
        },
        {
          id: "product-3",
          name: "Special Soup",
          ...
          imageAlt: "Special Soup",
        },
        {
          id: "product-4",
          name: "Chicken Biriyani",
          price: "৳৩০০ - ৳৫৫০",
          imageSrc: "http://img.b2bpic.net/free-photo/chigirtma-sebzi-plov-rice-garnish-with-vegetables-herbs_114579-876.jpg",
        ...
        },
        {
          ...
          price: "৳৩২০ - ৳৫০০",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-dough-pasta-cooked-tasty-with-meat-vegetables-salted-inside-round-green-plate-with-flower-pink-desk_140725-24378.jpg",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          imageAlt: "Fariha Islam",
        },
        {
          id: "testimonial-item-4",
          name: "মাহমুদ হাসান",
          role: "ব্যবসায়ী",
          company: "মাহমুদ এন্টারপ্রাইজ",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/serious-beautiful-middle-aged-business-woman_1262-3072.jpg",
          imageAlt: "Mahmud Hasan",
        },
        {
          id: "testimonial-item-5",
          name: "তাসনিয়া জান্নাত",
          role: "গৃহিনী",
          company: "গৃহপরিচারিকা",
          rating: 4,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-smiling-young-man-isolated-white-background_23-2148056445.jpg",
          imageAlt: "Tasnia Jannat",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "faq-1",
          title: "আপনারা কখন খোলা থাকেন?",
          content: "আমাদের রেস্তোরাঁ প্রতিদিন সকাল ১০টা থেকে রাত ১১টা পর্যন্ত খোলা থাকে।",
        },
        {
          id: "faq-2",
          title: "টেবিল রিজার্ভ করার কি কোনো ব্যবস্থা আছে?",
          content: "হ্যাঁ, আপনি আমাদের ওয়েবসাইটে বা ফোন করে টেবিল রিজার্ভ করতে পারেন।",
        },
        {
          id: "faq-3",
          title: "আপনারা কি হোম ডেলিভারি দেন?",
          content: "আমরা নির্দিষ্ট এলাকার মধ্যে হোম ডেলিভারি সার্ভিস প্রদান করি। বিস্তারিত জানতে আমাদের সাথে যোগাযোগ করুন।",
        },
        {
          id: "faq-4",
          title: "আপনাদের মেন্যুতে কি ভেগান অপশন আছে?",
          content: "আমাদের মেন্যুতে কিছু ভেগান এবং নিরামিষ অপশন আছে। আপনার পছন্দের জন্য আমাদের স্টাফদের জিজ্ঞাসা করতে পারেন।",
        },
      ]}
  ...
  <div id="contact-info" data-section="contact-info">
      ...
      features={[
        {
          title: "আমাদের ঠিকানা",
          description: "নিউ ব্রিজ, কালিকাডোবা, গোবিন্দগঞ্জ, ৫৭৪০ (Unnamed Road)",
          imageSrc: "http://img.b2bpic.net/free-photo/coffee-pins-map_23-2147635444.jpg",
          imageAlt: "Location Icon",
        },
        {
          title: "কল করুন",
          description: "০১৭১৭-৯৯৯১৮৯",
          imageSrc: "http://img.b2bpic.net/free-photo/dgital-tablet-mobile-phone-near-stickers-social-media-icons_23-2147841405.jpg",
          imageAlt: "Phone Icon",
        },
        {
          title: "ইমেইল করুন",
          description: "randhan.shala99@gmail.com",
          imageSrc: "http://img.b2bpic.net/free-photo/set-social-media-icon-illustration_53876-146266.jpg",
          imageAlt: "Email Icon",
        },
        {
          title: "সার্ভিস সমূহের সুবিধা",
          description: "ডাইন-ইন, ড্রাইভ-থ্রু, নো-কন্ট্যাক্ট ডেলিভারি",
          imageSrc: "http://img.b2bpic.net/free-vector/hotel-icons-collection_23-2147498524.jpg",
